                                    ...
                                    <form id="kt_ecommerce_settings_general_form" class="form" action="#">
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <style>.image-input-placeholder { background-image:{{url('assets/v1/admins/media/svg/files/blank-image.svg')}}; } [data-bs-theme="dark"] .image-input-placeholder { background-image: {{url('assets/v1/admins/media/svg/files/blank-image.svg')}}; }</style>
