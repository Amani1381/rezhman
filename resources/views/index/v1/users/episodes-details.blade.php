                    ...
                    <div class="episodes__details__pic">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <img src="{{asset('assets/v1/users/img/episodes-single/eps-1.jpg')}}" alt="">
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <img src="{{asset('assets/v1/users/img/episodes-single/eps-2.jpg')}}" alt="">
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <img src="{{asset('assets/v1/users/img/episodes-single/eps-3.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
