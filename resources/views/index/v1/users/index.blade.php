...
@section('content')
<!-- Hero Section Begin -->
<section class="hero spad set-bg" data-setbg="{{asset('assets/v1/users/img/hero/hero-bg.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="hero__pic set-bg" data-setbg="{{asset('assets/v1/users/img/hero/hero-video.png')}}">
...
<section class="callto spad set-bg" data-setbg="{{asset('assets/v1/users/img/call-bg.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="episodes__item set-bg" data-setbg="{{asset('assets/v1/users/img/episodes/episodes-1.jpg')}}">
                    <div class="tags"><span class="icon_tags_alt"></span> رادیو، موسیقی</div>
                    <div class="time ltr">40:00<span class="icon_clock_alt"></span></div>
                    <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/249690664&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"
                       class="play-btn video-popup"><img src="{{asset('assets/v1/users/img/play.png')}}" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="episodes__item set-bg" data-setbg="{{asset('assets/v1/users/img/episodes/episodes-2.jpg')}}">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="episodes__item set-bg" data-setbg="{{asset('assets/v1/users/img/episodes/episodes-3.jpg')}}">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="episodes__item set-bg" data-setbg="{{asset('assets/v1/users/img/episodes/episodes-4.jpg')}}">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="episodes__item set-bg" data-setbg="{{asset('assets/v1/users/img/episodes/episodes-5.jpg')}}">
                    <div class="tags"><span class="icon_tags_alt"></span> فرهنگی، اجتماعی</div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="episodes__item set-bg" data-setbg="{{asset('assets/v1/users/img/episodes/episodes-6.jpg')}}">
